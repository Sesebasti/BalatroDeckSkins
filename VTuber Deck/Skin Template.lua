--- STEAMODDED HEADER
--- MOD_NAME: VTuber Deck
--- MOD_ID: VTuber_Deck
--- PREFIX: oc_vtdck
--- MOD_AUTHOR: [Oceonax]
--- MOD_DESCRIPTION: Featuring 52 different Vtubers, one for every single card! Can you recognise anyone here?
--- VERSION: 1.0.0

local atlas_key = 'oc_vtdck_atlas' -- "{prefix}_atlas"

local atlas_lc_img = 'VTuber.png' -- Filename for the image in the asset folder
...
local description = 'VTuber Deck' -- English-language description, also used as default. Can also be a table for each suit.
