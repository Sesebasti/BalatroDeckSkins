--- STEAMODDED HEADER
--- MOD_NAME: deadsectro - my balatro skin
--- MOD_ID: deadsectro
--- PREFIX: dstro
--- MOD_AUTHOR: [deadsector, MillieAmp, SeSebasti]
--- MOD_DESCRIPTION: Contains Various Anthro Creatures over your face cards

local atlas_key = 'dstro_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'dstro.png' -- Filename for the image in the asset folder

local suits = {'hearts', 'clubs', 'diamonds', 'spades'} -- Which suits to replace
local ranks = {'Jack', 'Queen', "King",} -- Which ranks to replace

local description = 'deadsector' -- English-language description, also used as default
