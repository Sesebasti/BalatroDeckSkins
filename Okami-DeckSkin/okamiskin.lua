--- STEAMODDED HEADER
--- MOD_NAME: Okami Deck
--- MOD_ID: okami_deckall
--- PREFIX: okami
--- MOD_AUTHOR: [NEVER_Hiccups, Victin]
--- MOD_DESCRIPTION: Okami Card Skins
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: da2f15

local atlas_key = 'okami_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'okami_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'okami_hc.png' -- Filename for the high-contrast version of the texture, if existing
...
local description = 'Okami' -- English-language description, also used as default
