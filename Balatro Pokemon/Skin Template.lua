local atlas_key = '' -- "{prefix}_atlas"

local atlas_lc_img = '' -- Filename for the image in the asset folder
...
local description = '' -- English-language description, also used as default. Can also be a table for each suit.
