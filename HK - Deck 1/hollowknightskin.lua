...
local atlas_key = 'hk1_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'hollowknight_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'hollowknight_hc.png' -- Filename for the high-contrast version of the texture, if existing
