--- STEAMODDED HEADER
--- MOD_NAME: Star Fox Deck
--- MOD_ID: StarFoxDeck
--- PREFIX: SFD
--- MOD_AUTHOR: [rynagon and NyxForKicks]
--- MOD_DESCRIPTION: Star Fox Deck
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: FC03DF

local atlas_key = 'SFD'-- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'SFD_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'SFD_hc.png' -- Filename for the high-contrast version of the texture, if existing

local suits = {'diamonds'} -- Which suits to replace
local ranks = {'Jack', 'Queen', "King"} -- Which ranks to replace

local description = 'Star Fox' -- English-language description, also used as default
