--- STEAMODDED HEADER
--- MOD_NAME: Inscryption Deck
--- MOD_ID: ins_deckall
--- PREFIX: ins
--- MOD_AUTHOR: [NEVER_Hiccups, Victin]
--- MOD_DESCRIPTION: Inscryption Card Skins
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: AC885F

local atlas_key = 'ins_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'inscryption_lc.png' -- Filename for the image in the asset folder
...
local description = 'Inscryption' -- English-language description, also used as default
