--- STEAMODDED HEADER
--- MOD_NAME: Team Dark Deck
--- MOD_ID: TeamDarkDeck
--- PREFIX: TD
--- MOD_AUTHOR: [rynagon and NyxForKicks]
--- MOD_DESCRIPTION: Team Dark Deck
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: FC03DF

local atlas_key = 'TD'-- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'TD_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'TD_hc.png' -- Filename for the high-contrast version of the texture, if existing

local suits = {'hearts'} -- Which suits to replace
local ranks = {'Jack', 'Queen', "King"} -- Which ranks to replace

local description = 'Team Dark' -- English-language description, also used as default
