local atlas_key = 'ElRichModC' 

local atlas_lc_img = 'lowContrast.png' -- Filename for the image in the asset folder
local atlas_hc_img = 'highContrast.png' -- Optional, comment out if not used

local suits = {'Hearts', 'Clubs', 'Diamonds', 'Spades'} -- Which suits to replace
local ranks_to_use = {'Jack', 'Queen', "King", "Ace"} -- Which ranks to replace
...
local description = 'ElRichModC' -- English-language description, also used as default. Can also be a table for each suit.
